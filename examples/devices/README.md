...
| Divoom TimeBox-mini (11×11 LED) | Classic SPP, RFCOMM ch4 (byte-stuffed) | [divoom-timebox-mini.md](divoom-timebox-mini.md) | protocol only · SPP via [untether_spp](../../components/untether_spp/) bridge |
| Divoom Pixoo 16 (16×16 LED) | Classic SPP, RFCOMM ch2 (MiniToo transport) | [divoom-pixoo-16.md](divoom-pixoo-16.md) | protocol only · [untether_spp](../../components/untether_spp/) bridge bring-up device (verified) |
